    ...
    (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
      (function (t) {
              ...
              (u.charset = 'utf-8'),
                ...
                (u.src = (function (t) {
                  return (
                    ...
                    '.' +
                    {
                      0: 'bda7aacfecfa6a7bd7d77f5f5f6c2cbb',
                      2: '91541f59ad05f6022f2018f3e8e7fb49',
                      3: '0d6aa7fd095b2a9dd19cc66c7c2ed64b',
                      4: 'e5d94df7ab4c95927f918d61677aaf87',
                      5: '5c0d489a60c1dff81ec4f9d3a80c4dbd',
        ...
        function (t, e, n) {
          var r = n(8),
            i = n(59),
            o = 'https://platform.twitter.com',
            s = [
              'https://syndication.twitter.com',
              'https://cdn.syndication.twimg.com',
              'https://localhost.twitter.com:8444',
            ],
            a = ['https://syndication.twitter.com', 'https://localhost.twitter.com:8445'],
            u = [
            ...
            d = function () {
              ...
              return t && c(s, t) ? t : 'https://cdn.syndication.twimg.com';
            },
            l = function () {
              var t = r.get('settingsSvcHost');
              return t && c(a, t) ? t : 'https://syndication.twitter.com';
            };
          ...
          t.exports = {
            cookieConsent: function (t) {
              var e = t || [];
              return e.unshift('cookie/consent'), f(l(), e);
            },
            embedIframe: function (t, e) {
              ...
              return a && c(u, a)
                ? f(a, n) + '.html'
                : (n.unshift(i.getBaseURLPath(e)), f(s, n) + '.html');
            },
            eventVideo: function (t) {
              var e = t || [];
              return e.unshift('video/event'), f(d(), e);
            },
            grid: function (t) {
              var e = t || [];
              return e.unshift('grid/collection'), f(d(), e);
            },
            moment: function (t) {
              var e = t || [];
              return e.unshift('moments'), f(d(), e);
            },
            settings: function (t) {
              var e = t || [];
              return e.unshift('settings'), f(l(), e);
            },
            timeline: function (t) {
              var e = t || [];
              return e.unshift('timeline'), f(d(), e);
            },
            tweetBatch: function (t) {
              var e = t || [];
              return e.unshift('tweets.json'), f(d(), e);
            },
            video: function (t) {
              var e = t || [];
              return e.unshift('widgets/video'), f(d(), e);
            },
          };
        },
        function (t, e, n) {
        ...
        function (t, e, n) {
          ...
          t.exports = function (t, e, n, f) {
            var h,
              p = s.get(t.dataSource.id);
            return i.isHorizonTimelineEnabled(f, p)
              ? ((h = r.createElement('div')),
                new o(u, a, l.TIMELINE, t, e, n, {
                  sandboxWrapperEl: h,
                }))
        ...
        function (t) {
          t.exports = {
            tweetButtonHtmlPath:
              '/widgets/tweet_button.0504c5db6e58d499a7ba93c246a8554d.{{lang}}.html',
            followButtonHtmlPath:
              '/widgets/follow_button.0504c5db6e58d499a7ba93c246a8554d.{{lang}}.html',
            hubHtmlPath: '/widgets/hub.html',
            widgetIframeHtmlPath: '/widgets/widget_iframe.0504c5db6e58d499a7ba93c246a8554d.html',
          ...
          t.exports = function (t) {
            t.params({
              ...
              t.defineProperty('horizonEndpoint', {
                get: function () {
                  return o.embedIframe(['TimelineList']);
                },
              }),
              t.around('horizonQueryParams', function (t) {
                var e,
                  ...
                  o = this.params.id
                    ? {
                        listId: this.params.id,
                      }
                    : ((e = this.params),
                      (n = r.listScreenNameAndSlug(e.url) || e),
                      i.compact({
                        ownerScreenName: n.ownerScreenName,
                        slug: n.slug,
                      }));
                return i.aug(t(), o);
              }),
        ...
        function (t, e, n) {
          ...
          t.exports = function (t) {
            t.params({
              ...
              t.defineProperty('horizonEndpoint', {
                get: function () {
                  return s.embedIframe(['TimelineProfile']);
                },
              }),
              t.around('horizonQueryParams', function (t) {
                var e = u(this.params.url, this.params.screenName),
                  n = e
                    ? {
                        screenName: e,
                      }
        ...
        function (t, e) {
          ...
          t.exports = {
            get: function (t) {
              ...
              return -1 !== Object.keys(n).indexOf(e) && e;
            },
            DATASOURCE_MAP: n,
          };
        },
