...
const HeaderOuterMainContainer = styled.header`
	width: 100%;
	margin-bottom: 5px;
...
const HeaderNumberCountContainer = styled.div`
	height: 100%;
	display: flex;
	align-items: start;
	margin: 0 5px;
...
const ButtonLookalikeStyle = css`
	color: var(--refreshButtonColor);
	background: var(--navigationbarBackground);
	box-shadow: var(--refreshButtonShadow);
	border: var(--refreshButtonBorder);
	transition: color 250ms, background-color 250ms, border-color 250ms, box-shadow 250ms, opacity 250ms, filter 250ms;
...
const SearchListError = styled.span`
	position: absolute;
	top: 0;
