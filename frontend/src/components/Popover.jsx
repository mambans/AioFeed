 ...
 * @returns  JSX
 */
const Popover = ({ header, placement = "bottom", trigger, children, disabled, backgroundColor, triggerStyle = {} }) => {
	...
	return (
		<div ref={ref}>
			...
			<Overlay show={open} target={target} placement={placement} container={ref} containerPadding={20} onHide={handleClose}>
				<StyledReactPopover backgroundColor={backgroundColor} id={`popover-positioned-${placement}`}>
