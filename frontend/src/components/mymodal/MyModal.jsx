	...
	return (
		<>
			<Container ref={parentRef}>
				...
				<CSSTransition in={show} timeout={direction ? duration : 0} classNames="slideLeft" unmountOnExit appear onEnter={onOpen} onExited={onClose}>
...
const SModal = styled.div`
	...
	&.slideLeft-appear {
		...
		transition: opacity ${({ duration }) => duration / 2 + "ms"}, transform ${({ duration }) => duration + "ms"};
	}
