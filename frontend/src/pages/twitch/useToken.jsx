...
export const TwitchProvider = ({ children }) => {
	...
	const [updateNotischannels, setUpdateNotischannels] = useSyncedLocalState("ChannelsUpdateNotifs", []);
	...
	}, [setTwitchAccessToken, setTwitchRefreshToken, setTwitchUserId, setTwitchUsername, setTwitchProfileImage, setFavStreams, setUpdateNotischannels]);
