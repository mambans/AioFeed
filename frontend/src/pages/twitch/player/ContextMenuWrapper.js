...
const ContextMenuWrapper = ({ outerContainer, showAndResetTimer = () => {}, includeMarginTop, children }) => {
	...
	// if (show?.show) {
	return (
		<Container left={show?.x} top={show?.y} ref={menuRef} maxHeight={show?.maxHeight} show={show?.show}>
