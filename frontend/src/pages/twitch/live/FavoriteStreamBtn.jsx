...
const FavoriteStreamBtn = ({ id, channel, size = "1.4em", loweropacity, marginright, show = true, style }, ...props) => {
	...
	return (
		<ToolTip delay={{ show: 500, hide: 0 }} width="max-content" tooltip={`${enabled ? "Remove" : "Add"} ${channel} as a favorite.`}>
			<VodAddRemoveButton
