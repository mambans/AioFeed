...
export const NotificationsProvider = ({ children }) => {
	...
	const [unseenNotifications, setUnseenNotifications] = useSyncedLocalState("notificationsUnreadCount", []);
			...
			if (notis && notis.length) {
				new Promise((resolve, reject) => {
					try {
						...
						const newNotificationsWithAddedProps = notis?.map((n = {}) => ({
						...
						const finalNotifications = [...newNotificationsWithAddedProps, ...existingNotifications].splice(0, 200);
