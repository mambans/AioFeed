...
const EditAccount = () => {
	...
	const { value: password, bind: bindPassword, reset: resetPassword } = useInput("", null, () => setError(null));
	// eslint-disable-next-line no-unused-vars
	...
	return (
		<>
			...
			<Modal show={open} onHide={handleClose} dialogClassName={styles.modal} backdropClassName={styles.modalBackdrop}>
				<Modal.Body>
					{openDelete ? (
						...
						<>
							...
							<Form onSubmit={handleSubmit}>
								...
								<Form.Group controlId="formBasicNewPassword">
									...
									<Form.Control type="password" placeholder="Enter new password" {...bindNewPassword} />
								</Form.Group>
								<Form.Group controlId="formBasicNewPasswordConfirm" style={{ marginTop: 10 }}>
									<Form.Control type="password" placeholder="Enter new password again" {...bindNewPasswordConfirm} />
								</Form.Group>
